class archivematica::storage_service::config::uwsgi inherits archivematica {
  ...
  uwsgi::app {'am_storage':
    ...
    environment_variables => {
        ...
        'EMAIL_HOST'             => $storage_uwsgi_email_host,
        'EMAIL_HOST_PASSWORD'    => $storage_uwsgi_email_host_password,
        'EMAIL_HOST_USER'        => $storage_uwsgi_email_host_user,
        'EMAIL_PORT'             => $storage_uwsgi_email_port,
        'SS_DB_HOST'             => $storage_uwsgi_db_host,
        'SS_DB_NAME'             => $storage_uwsgi_db_name,
        'SS_DB_PASSWORD'         => $storage_uwsgi_db_password,
        'SS_DB_USER'             => $storage_uwsgi_db_user,
